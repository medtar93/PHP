...
if (!internauteEstConnecte()) {   // si le membre n'est pas connecté, il ne doit pas avir accès à la page profil
...
//debug($_SESSION);
extract($_SESSION['membre']);   // Extrait tous les indices de l'array sous forme de vriables auxquelles on affecte la valeur dans l'array. Exemple : $_SESSION['membre']['pseudo'] devient $pseudo = $_SESSION['membre']['pseudo'];
...
?>
    ...
    <h3>Voici vos informatons de profil.</h3>
